...
class _StateDemoState extends State<StateDemo> with TickerProviderStateMixin {
                      ...
                      Row(
                        children: [
                          AppButton(
                            ...
                            type: ButtonType.secondary,
                            onPressed:
                                _items.isNotEmpty ? () => _clearItems() : null,
                          ),
                          const SizedBox(width: 8),
                          AppButton(
                            text: '随机排序',
                  ...
                  return Column(
                    children: [
                      ...
                      AppButton(
                        ...
                        type: ButtonType.secondary,
                        onPressed:
                            _asyncResult.value.isNotEmpty && !_isLoading.value
                                ? () => _clearAsyncResult()
                                : null,
                      ),
                    ],
